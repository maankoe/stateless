...
def stateless(
        ...
        arg_copy_funcs: Optional[Union[Mapping[str, Callable[[T], T]], Iterable[Callable[[T], T]]]] = None
):
...
def _copy_kwargs(
    ...
    if arg_copy_funcs is None:
        ...
        return {kw: arg_copy_funcs[kw](arg) if kw in arg_copy_funcs else copy_func(arg)
